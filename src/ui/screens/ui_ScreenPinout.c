...
void ui_ScreenPinout_screen_init(void)
{
    ...
    ui_ImagePinout = lv_img_create(ui_ScreenPinout);
    lv_img_set_src(ui_ImagePinout, &ui_img_micro_sd_sniffer_2_320_x_190_png);
    lv_obj_set_width(ui_ImagePinout, LV_SIZE_CONTENT);   /// 320
    lv_obj_set_height(ui_ImagePinout, LV_SIZE_CONTENT);    /// 170
    lv_obj_set_x(ui_ImagePinout, -1);
    lv_obj_set_y(ui_ImagePinout, -19);
    lv_obj_set_align(ui_ImagePinout, LV_ALIGN_CENTER);
    lv_obj_add_flag(ui_ImagePinout, LV_OBJ_FLAG_ADV_HITTEST);     /// Flags
    lv_obj_clear_flag(ui_ImagePinout, LV_OBJ_FLAG_SCROLLABLE);      /// Flags
